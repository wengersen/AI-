...
const siteContent = {
  ...
  section1: {
    ...
    aiTranslation: {
      title: "AI 翻译",
      icon: "🌐",
      description: "覆盖原文管理、文字处理、测试环境搭建、游戏内文字效果测试到上线的全流程AI翻译体系，通过纯AI、计划转AI、人工确认三层架构逐步提升AI翻译覆盖率。",
      highlights: [
        "25年全年全语种纯AI翻译占比约80%，核心语种英语纯AI翻译占比22%",
        "原文预处理降低字数比例47%，全年100%利用AI进行质检验收",
        "26年计划全语种纯AI翻译占比提升至90%（+10%），纯AI翻译占比约36%（+14%）",
        "关键步骤保留人工确认环节，完成全流程优化后预计可降低到1人力"
      ],
      cases: [
        {
          title: "AI翻译全流程架构",
          description: "从原文管理→文字处理→测试环境搭建→游戏内文字效果测试→上线的完整链路，三层并行：纯AI自动处理、计划转AI逐步替代、人工确认兜底质量。当前共需2人力，完成全流程优化后预计可降低到1人力。",
          image: "assets/images/AI翻译/AI翻译.png",
          video: ""
        }
      ]
    },
